        ...
        for args in dataset_list:
            ...
            for cam_idx in cam_idxs:
                ...
                if cfg.task == 'zju_mocap':
                    if skip=='10':
                        select_framelist = framelist[::skip][1:]
                    if skip=='3':
                        select_framelist = framelist[::skip][4:]
                elif cfg.task == 'AIST_mocap':
                ...
                print(sub_idx, cam_idx, total_frames, select_framelist)
...
#            alpha_mask = cv2.undistort(alpha_mask, K, D)
    ...
    def __getitem__(self, idx):
        ...
        if results['sub_idx']=='387':
            if skip==10:
                render_frame_names = ['frame_000010', 'frame_000070', 'frame_000100']
            if skip==3:
                render_frame_names = ['frame_000012', 'frame_000075', 'frame_000099']
        ...
        if results['sub_idx']=='d16':
            if skip==10:
                render_frame_names = ['frame_000200', 'frame_000400', 'frame_000560']
        ...
        if results['sub_idx']=='d20':
            if skip==10:
                render_frame_names = ['frame_000200', 'frame_000400', 'frame_000560']
        #print(results['sub_idx'], results['cam_idx'], results['frame_name'], render_frame_names)
        if cfg.use_data_cross_pose or cfg.use_data_cross_view:
