            ...
            for cam_idx in cam_idxs:
                ...
                if cfg.task == 'AIST_mocap':
                    if skip==60:
                        ...
                        share_framelist = framelist[::skip][:-3]
                        if sub_idx == 'd16':
                            render_framelist = ['frame_000204', 'frame_000832', 'frame_000844']
                        if sub_idx == 'd17':
                            render_framelist = ['frame_000564', 'frame_001228', 'frame_001252']
                        if sub_idx == 'd18':
                            render_framelist = ['frame_000200', 'frame_000708', 'frame_000736']
                        if sub_idx == 'd19':
                            render_framelist = ['frame_000212', 'frame_000408', 'frame_000556']
                        if sub_idx == 'd20':
                            render_framelist = ['frame_000204', 'frame_000700', 'frame_000712']
                        select_framelist = render_framelist + share_framelist

                elif cfg.task == 'zju_mocap':
                    if skip==60:
                        select_framelist = ['frame_000000', 'frame_000075', 'frame_000150', 'frame_000225', 'frame_000300']
                    else:
                ...
                print("#############################################")
                print("selected frames for finetuning: ", select_framelist)
                print("#############################################")
